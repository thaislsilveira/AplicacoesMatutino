 ...
 * @author PC 05
 */
@WebServlet(name = "CalculandoValor", urlPatterns = {"/CalculandoValor"})
public class CalculandoValor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println(dvalora+ "" +operador + "" + dvalorb +" = " + resultado );
    }
    }
