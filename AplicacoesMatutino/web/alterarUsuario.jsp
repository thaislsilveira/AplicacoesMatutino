<%-- 
    ...
    Created on : 18/09/2018, 10:22:48
    Author     : PC 05
--%>
            ...
            <form name="alterarusuario" id="alterarusuario" action="AlterarUsuario"  method="POST">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="dataNascimentoUsuario" name="dataNascimentoUsuario"  value="<fmt:formatDate value = '${usuario.dataNascimentoUsuario}'/>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="loginUsuario">Login</label>
                    <input  type="text" name="loginUsuario" id="loginUsuario" class="form-control" value="${usuario.loginUsuario}">
                </div>
                <div class="form-group">
